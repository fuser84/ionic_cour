...
import {Nav, Platform, ModalController, Modal, LoadingController} from 'ionic-angular';
...
export class MyApp {
  ...
  initializeApp() {
    //platform is the service that let you obtain info from the current device!!!
        ...
        .subscribe(() => {
          setTimeout( () => {
            if(this.network.type == '3g'){
              console.log(`We've got a 3g connection, woohoo!`);
            }
          }, 3000);
          if(this.loading){
